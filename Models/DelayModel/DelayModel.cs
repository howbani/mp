...
namespace MP.DelayModel
{
    ...
    public class DelayModel
    {
        ...
        /// <param name="rc"></param>
        /// <returns></returns>
        public static double Delay(Sensor tx, Sensor rc, Packet packet)
        {
            double Distance = Operations.DistanceBetweenTwoSensors(tx, rc);
            //https://en.wikipedia.org/wiki/Transmission_delay
            double TransmissionDelay = packet.PacketLength / PublicParamerters.TransmissionRate;
