    ...
    public class RandomWaypointMobilityModel
    {
       ...
       private bool isBound =false ;
        ...
        public void BeginWalk()
        {
            ...
            speed = Speed; // random distrubiton
        ...
        public void ScheduleMobility()
        {
            ...
            MovmentScheduler.Interval = TimeSpan.FromSeconds(speed);
            m_current = ObjectPosition;
            ...
            ObjectToMove.Width += 0.000001; // just to trigger an event. dont remove this line.


            if (Settings.Default.ShowSinkTrace)
            {
                Operations.DrawLine(PublicParamerters.MainWindow.Canvas_SensingFeild, m_current, moveto, 0.7);
            }
